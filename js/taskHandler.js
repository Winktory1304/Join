...
function addSubtask() {
  ...
  subtaskElement.innerHTML = `<label id="${subtask.length-1}" for="addsubtaskliste" >${subtaskText}  <svg onclick="editSubtask('${subtaskText}','${text}')" width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
